...
it('supprime les fichiers physiques et les entrées media quand un article est supprimé', function () {
    ...
    $this->actingAs($user)->delete("/admin/articles/{$article->slug}");
