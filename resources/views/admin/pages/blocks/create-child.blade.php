<x-admin.layout>
    <h1 class="text-2xl font-bold mb-4">
        Ajouter un bloc — Colonne {{ $columnIndex + 1 }} — {{ $page->title }}
    </h1>

    <form action="{{ route('admin.pages.blocks.columns.store', [$page, $parent->id, $columnIndex]) }}" method="POST" enctype="multipart/form-data">
        @csrf
