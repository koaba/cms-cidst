<x-admin.layout>
    <h1 class="text-2xl font-bold mb-4">
        Ajouter un bloc — Colonne {{ $slotIndex + 1 }} — {{ $page->title }}
    </h1>

    <form action="{{ route('admin.pages.blocks.columns.store', [$page, $parent->id, $slotIndex]) }}" method="POST" enctype="multipart/form-data">
        @csrf
