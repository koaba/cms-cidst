<x-admin.layout>
    ...
    <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg space-y-4">
        @csrf
        <div>
        ...
        <div>
            ...
            <input type="file" name="pdfs[]" id="pdfs" accept="application/pdf" multiple
                   class="w-full border rounded p-2">
            <p class="text-xs text-gray-500 mt-1">10 fichiers max, 10 Mo max chacun.</p>
